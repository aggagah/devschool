			...
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-md-6" style={{ border: "1px solid black" }}>
						...
						<Form onSubmitForm={this.onSubmitHandler} onChange={this.inputChangeHandler} first_name={this.state.first_name} last_name={this.state.last_name} buttonDisabled={this.state.buttonDisabled} />
					</div>
				</div>
			</div>
		);
