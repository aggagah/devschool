    ...
    <div className="col-md-6" key={props.member.id}>
        <div className="card" style={{ margin: "10px" }}>
            <div className="card-body">
                ...
                <button className="btn btn-primary" onClick={() => props.editButtonClick(props.member)}>
                    Edit
                </button>
                <button className="btn btn-danger" onClick={() => props.deleteButtonClick(props.member.id)}>
                    Delete
                </button>
            </div>
        </div>
